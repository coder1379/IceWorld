...
/**
 * SiteApiSearch represents the model behind the search form of `common\services\site\SiteApiModel`.
 */
class SiteApiSearch extends SiteApiModel
{
    /**
     * {@inheritdoc}
     */
