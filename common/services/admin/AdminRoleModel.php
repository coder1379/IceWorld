 ...
 * @property string $other_auth_list
...
class AdminRoleModel extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    public function rules()
    {
        ...
        return [
            [['name'], 'required'],
            [['auth_list', 'other_auth_list'], 'string'],
            [['type', 'status', 'add_admin_id', 'show_sort', 'is_delete'], 'integer'],
            [['add_time'], 'safe'],
            [['name'], 'string', 'max' => 20],
        ];
    }
    ...
    public function scenarios()
    {
        ///////模型使用场景
                return [
        'create' => ['name','auth_list','other_auth_list','type','status','add_admin_id','add_time','show_sort',],//创建场景

        'update' => ['name','auth_list','other_auth_list','type','status','add_admin_id','add_time','show_sort',],//修改场景
