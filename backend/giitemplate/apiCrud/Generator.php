...
namespace backend\giitemplate\apiCrud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'logic' => 'logic code:common\services\user\UserLogic',
    ...
    public function generate()
    {
        ...
        if (!empty($this->logic)) {
            $logicServer = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->logic, '\\') . '.php'));
            $files[] = new CodeFile($logicServer, $this->render('logic.php'));
        }
