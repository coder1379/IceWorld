...
/* @var $searchModel backend\models\adminrole\AdminRoleSearch */
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 管理员角色管理
    <span class="c-gray en">&gt;</span> 管理员角色列表
...
['class'=>'yii\grid\DataColumn','value'=>'name','label' => '角色名字'],
//['format'=>'raw','value'=>function($data){ return ''; },'label' => '权限列表'],
//['class'=>'yii\grid\DataColumn','value'=>'other_auth_list','label' => '附属权限列表'],
