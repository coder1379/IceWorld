                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li>
                                <a href="javascript:void(0);" onclick="backend_view_data('查看管理员信息','<?php echo Yii::$app->urlManager->createUrl("index/admininfo"); ?>',this,0,layerOpenWindowWidth,layerOpenWindowHeight)">管理员信息</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="backend_view_data('修改密码','<?php echo Yii::$app->urlManager->createUrl('index/updatepassword'); ?>',this,0,layerOpenWindowWidth,layerOpenWindowHeight)">修改密码</a>
                            </li>
                            <li>
