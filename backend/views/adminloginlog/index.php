...
/* @var $searchModel common\services\admin\AdminLoginLogSearch */
...
<nav class="breadcrumb index-nav-list">
    ...
    <span class="c-gray en">&gt;</span> 管理员登录日志管理
    <span class="c-gray en">&gt;</span> 管理员登录日志列表
...
['class'=>'yii\grid\DataColumn','value'=>function($data){   return $data->adminRecord->nickname??'';},'label' => '名称'],
['class'=>'yii\grid\DataColumn','value'=>function($data){   return $data->typePredefine[$data['type']]??'';},'label' => '登录类型'],
['class'=>'yii\grid\DataColumn','value'=>function($data){ if($data->add_time>0){ return date('Y-m-d H:i:s',$data->add_time); }else{ return ''; } },'label' => '登录时间'],
['class'=>'yii\grid\DataColumn','value'=>'ip','label' => 'ip'],
['class'=>'yii\grid\DataColumn','value'=>'device_desc','label' => '设备描述'],
