...
//['class'=>'yii\grid\DataColumn','value'=>'username','label' => '用户名'],
...
['class'=>'yii\grid\DataColumn','value'=>function($data){   return $data->typePredefine[$data['type']]??'';},'label' => '用户类型'],
//['class'=>'yii\grid\DataColumn','value'=>'level','label' => '等级'],
//['class'=>'yii\grid\DataColumn','value'=>'realname','label' => '真实姓名'],
//['class'=>'yii\grid\DataColumn','value'=>'email','label' => '邮箱'],
['value'=>function($data){ return Html::a(Html::img($data->avatar,['class' => 'backend-index-img']),$data->avatar,['target' => '_blank']);},'label'=>'头像','format'=>'raw'],
...
//['class'=>'yii\grid\DataColumn','value'=>function($data){ if($data->birthday>0){ return date('Y-m-d H:i:s',$data->birthday); }else{ return ''; } },'label' => '生日'],
//['class'=>'yii\grid\DataColumn','value'=>'district','label' => '地区'],
//['class'=>'yii\grid\DataColumn','value'=>'title','label' => '头衔'],
//['class'=>'yii\grid\DataColumn','value'=>'token','label' => 'token'],
['class'=>'yii\grid\DataColumn','value'=>function($data){ if($data->add_time>0){ return date('Y-m-d H:i:s',$data->add_time); }else{ return ''; } },'label' => '注册时间'],
