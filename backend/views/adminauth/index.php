...
/* @var $searchModel backend\models\adminauth\AdminAuthSearch */
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 管理员权限管理
    <span class="c-gray en">&gt;</span> 管理员权限列表
...
['class'=>'yii\grid\DataColumn','value'=>'name','label' => '名称'],
['class'=>'yii\grid\DataColumn','value'=>'auth_flag','label' => 'controller/action'],
['class'=>'yii\grid\DataColumn','value'=>function($data){   return empty($data->parentAdminAuthRecord->name)!=true?$data->parentAdminAuthRecord->name:'';},'label' => '上级'],
['class'=>'yii\grid\DataColumn','value'=>'other_auth_url','label' => '其他权限'],
