...
<nav class="breadcrumb index-nav-list">
    ...
    <span class="c-gray en">&gt;</span> 系统配置文件管理
    <span class="c-gray en">&gt;</span> 系统配置文件列表
...
['class'=>'yii\grid\DataColumn','value'=>'name','label' => '配置名称'],
['class'=>'yii\grid\DataColumn','value'=>'c_val','label' => '配置值'],
['class'=>'yii\grid\DataColumn','value'=>'desc','label' => '描述'],
...
['class'=>'yii\grid\DataColumn','value'=>function($data){ if($data->update_time>0){ return date('Y-m-d H:i:s',$data->update_time); }else{ return ''; } },'label' => '更新时间'],
